    ...
    return (
      <div className="pt-32 pb-16 px-4 sm:px-6 text-center">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-gray-500 mb-6 text-sm sm:text-base">Ajoutez des délicieuses pâtisseries à votre panier</p>
          <Link href="/menu">
              ...
              {items.map((item) => (
                <div key={item.id} className="p-4 sm:p-6 flex items-center space-x-3 sm:space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-500 text-xs sm:text-sm">Quantité: {item.quantity}</p>
